...
@wallet_pll_status1 @ubiquity_collision @sandbox_regression
  ...
  @wallet_pll_status2 @ubiquity_collision @sandbox_regression
  ...
  @wallet_pll_status3 @ubiquity_collision @sandbox_regression
  ...
  @wallet_pll_status4 @ubiquity_collision @sandbox_regression
  ...
  @wallet_pll_status5 @ubiquity_collision @sandbox_regression
  Scenario Outline: Verify wallet pll links for active payment account and unauthorised loyalty card for two users
    ...
    @wallet_delete_lc_pll @sandbox_regression
  Scenario Outline: No PLL link when loyalty card deleted from single wallet
   Given I am in Bink channel to get b2b token
    ...
    @wallet_delete_pc_pll @sandbox_regression

...
@membership_cards_pll  @pll_get_wallet_lc_id_multi
Feature: View multi wallet pll
  ...
  @multi_wallet_lc_pll_status1 @sandbox_regression
  ...
  @multi_wallet_lc_pll_status2 @sandbox_regression
  ...
  @multi_wallet_lc_pll_status3 @sandbox_regression
  ...
  @multi_wallet_lc_pll_status4 @sandbox_regression
  ...
  @multi_wallet_lc_pll_status5 @ubiquity_collision @sandbox_regression
  Scenario Outline: Verify wallet pll links for active payment account and unauthorised loyalty card for two users
    ...
    @multi_wallet_lc_delete_lc_pll @sandbox_regression
  ...
  @multi_wallet_lc_delete_pc_pll @sandbox_regression
   Scenario Outline: No PLL link when loyalty card deleted from single wallet
     Given I am in Bink channel to get b2b token
     When I perform POST token request for token type "b2b" to get access token
     And I perform POST request to add a new "<payment_card_provider>" payment account to wallet

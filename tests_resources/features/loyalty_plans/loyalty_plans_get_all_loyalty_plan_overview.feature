...
Feature: View Loyalty Plans Overview
 ...
 so that I can display this on the front end without having to call the larger GET /loyalty_plans endpoint
  ...
  @loyalty_plans_overview_success @bink_regression_api2 @sandbox_regression  @temp
  ...
  @loyalty_overview_is_in_wallet @bink_regression_api2 @sandbox_regression
  ...
  @loyalty_plans_overview_invalid_token @invalid_token @bink_regression_api2 @sandbox_regression

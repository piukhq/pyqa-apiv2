...
@when(parsers.parse('I perform POST request to update email with "{request_payload}"'
                    ' with "{status_code}"')
      )
...
@when(
    parsers.parse('I perform POST request to update email with "{duplicate_email}"  with "{status_code}"')
      )

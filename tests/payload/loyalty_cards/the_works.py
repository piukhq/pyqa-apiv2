...
class TheWorks:
    ...
    def add_and_auth_field_only_membership_card_with_unauthorised_json(membership_card=None, request_payload=None):
            ...
            if request_payload == "invalid_cardnumber":
                TestContext.card_number = TestDataUtils.TEST_DATA.the_works_membership_card.get(constants.INVALID_CARD_NUMBER)
            elif request_payload == "invalid_cardnumber":
                TestContext.card_number = TestDataUtils.TEST_DATA.the_works_membership_card.get(constants.UNKNOWN_CARD_NUMBER)
